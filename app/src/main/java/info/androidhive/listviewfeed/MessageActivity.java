...
import info.androidhive.listviewfeed.adapter.AwesomeAdapter;
import info.androidhive.listviewfeed.data.Message;
import info.androidhive.listviewfeed.data.Utility;
...
public class MessageActivity extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String title=intent.getStringExtra("friendName");
